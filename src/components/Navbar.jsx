  ...
  const dropdownRef = useRef(null);
        ...
        const handleResize = () => {
            if(isDropdownOpen){
                ...
                if(dropdownBottom > windowHeight) {
                    ...
                    const heightDifference = dropdownBottom - windowHeight;
          
                    // Adjust the position of other elements by the height difference
    ...
    const toggleDropdown = () => {
      ...
      const handleMouseEnter = () => {
        ...
        if (aboutLink) {
          const { top, left, height } = aboutLink.getBoundingClientRect();
    ...
    return (
        <header className='shadow-md  font-sans tracking-wide relative z-50'>
            <section
                className='flex items-center lg:justify-center flex-wrap gap-5 relative py-3 px-10   lg:min-h-[80px] max-lg:min-h-[60px]'>
                <a href=""><img src="https://yt3.googleusercontent.com/lupLP_XKwS4oxXpQ4WT4CcBngAUb3PruvFvM4gdXH5lOC2h_9sCfF2PsxOun5O3dFCGwaq7B=s900-c-k-c0x00ffffff-no-rj" alt="St marx Acadmey"
                    className='md:w-[100px] w-36 rounded-full' />
                </a>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="cursor-pointer" width="20px" height="20px"
                        ...
                        <g clipPath="url(#a)" transform="matrix(1.33 0 0 -1.33 0 682.667)">
                            <path
                                ...
                                data-original="#000000" />
                            <path fill="none" stroke="currentColor" strokeLinecap="round" stroke-line-join="round" strokeMiterlimit="10"
                                strokeWidth="40"
                ...
                <div id="collapseMenu"
                    ...
                    <ul
                        ...
                        <li className='mb-6 hidden max-lg:block'>
                            <a href="#"><img src="" alt="St marx Acadmey" className='w-36' />
                            </a>
                        </li>
                        <li className='max-lg:border-b max-lg:py-3'><Link to={'/'}>Home</Link> </li>
                        {/* <li className='max-lg:border-b max-lg:py-3'><Link to={'/about'}>About</Link> </li> */}
                        <li
                        ...
                        >
                            ...
                            {isDropdownOpen && (
                                <div className="absolute top-full left-0 bg-black z-100 border border-gray-200 shadow-lg p-4"style={{ top: dropdownPosition.top, left: dropdownPosition.left }} ref={dropdownRef}>
                                    {/* Dropdown content */}
                                    <ul>
                        ...
                        <li className='max-lg:border-b max-lg:py-3'><Link to={'/event'}>Events</Link> </li>
                        <li className='max-lg:border-b max-lg:py-3'><Link to={'/galary'}>Galary</Link> </li>
                        <li className='max-lg:border-b max-lg:py-3'><Link to={'/contact'}>Contact</Link> </li>
