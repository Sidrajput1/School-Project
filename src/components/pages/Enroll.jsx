...
function Enroll() {
    ...
    return (
        <div  className="image-container relative md:bottom-0 bottom-[-100px] md:py-4 py-2" data-aos="flip-left"
        ...
        data-aos-duration="2000">
            ...
            <div className=" md:absolute h-auto  relative md:top-[55%] top-[20%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white ">
                <div className=''>
