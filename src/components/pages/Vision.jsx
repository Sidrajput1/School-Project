                ...
                <div className='w-full min-h-[70vh]  flex flex-col  gap-10'>
                    <div className=' w-[100%] flex flex-row  '>
                        ...
                        <div className='m-auto'>
                            <h1 className='md:text-8xl text-4xl font-serif font-semibold italic rotate-12'>Vision</h1>
                        </div>
                    </div>
                    <div className='w-full flex flex-row-reverse   justify-end items-end'>
                        ...
                        <div className='m-auto'>
                            <h1 className='md:text-8xl text-4xl font-serif font-semibold italic -rotate-45'>Misson</h1>
                        </div>
                    </div>
                </div>
            </div>
