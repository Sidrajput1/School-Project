...
function Form() {
    return (
        <div className="font-[sans-serif] max-w-6xl mx-auto relative bg-white rounded my-6">
            <div className="grid lg:grid-cols-3 items-center">
                <div className="grid sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:mb-8">
                    <div className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                        ...
                        <h4 className="text-[#333] text-base font-extrabold mt-4">Visit School</h4>
                        <p className="text-sm tect-gray-400 mt-2"> First Buildung Of Lane Number-7 Gali No 2 Chandmari Road, Kankarbagh,Patna</p>
                    </div>
                    <div className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                        ...
                        <p className="text-sm tect-gray-400 mt-2">9308467268</p>
                        <p className="text-sm tect-gray-400 mt-2">9835611007</p>
                    </div>
                    <div className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                        ...
                        <p className="text-sm tect-gray-400 mt-2">stmarxacademy@gmail.com</p>
                    </div>
                    <div className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                        
                        <h4 className="text-[#333] text-base font-extrabold mt-4">Social Media</h4>
                        <p className="text-sm tect-gray-400 mt-2">Instagram: st.marx_academy</p>
                        <p className="text-sm tect-gray-400 mt-0">Facebook: ST MARX ACADEMY PATNA</p>
