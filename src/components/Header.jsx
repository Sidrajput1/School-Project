    ...
    return (
        ...
        <div>
            <section
                ...
                <div className=''>
                    <p className='text-sm font-semibold text-gray-500 md:text-justify text-left'>
                ...
                <div className="space-x-6 md:absolute md:right-10 flex items-center max-md:ml-auto">
                    ...
                    <Link to={'/login'} onClick={hideLoginButton}>
                            <button className='btn rounded-3xl bg-amber-200 my-1'>LogIn</button>
                        </Link>
                    ): 
                    (
                       <Link to={'/'} onClick={{showLoginButton}}>Back</Link>
